...
<div id="login">
    <div class="container">
        <div class="login sign-up-htm">
            <form action="${pageContext.request.contextPath}/updateUserServlet" method="post" class="container offset1 loginform" id="registerform" style="max-width: 820px;top: 120px;">
                    ...
                    <section class="content" style="align: left">
                        <span class="input input--hideo">
                            <input class="input__field input__field--hideo" type="text" id="register-username"
                                   name="useid" autocomplete="off" placeholder="请输入用户名" value="${user.id}" readonly="readonly" maxlength="8"/>
                        ...
                        <span class="input input--hideo">
                                <input class="input__field input__field--hideo" type="password" id="register-password" name="password" placeholder="请输入密码" value="${user.password}" maxlength="15"/>
                        ...
                        <span class="input input--hideo">
                                <input class="input__field input__field--hideo" type="text" id="psq"name="psq" placeholder="密保问题" value="${user.psq}" maxlength="20"/>
                        ...
                        <span class="input input--hideo">
                                <input class="input__field input__field--hideo" type="text" id="answer"name="answer" placeholder="密保答案" value="${user.answer}" maxlength="20"/>
