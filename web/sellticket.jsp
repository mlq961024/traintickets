...
<div class="container">
    <div style="float: left;">
        <form class="form-inline" action="${pageContext.request.contextPath}/myTicketServlet" method="post">

            <div class="form-group">
                <label >请输入查询信息</label>
                <label for="exampleInputName1">乘车人身份识别码：</label>
                <input type="text" name="riderid" value="${riid}" class="form-control" id="exampleInputName1" >
            </div>
            <div class="form-group">
                <label for="exampleInputName2">乘车人姓名：</label>
                <input type="text" name="ridername" value="${riname}" class="form-control" id="exampleInputName2" >
            </div>
                ...
                <ul class="pagination">
                    <c:if test="${pb.currentPage != 1}">
                        <li>
                            ...
                            <a href="${pageContext.request.contextPath}/myTicketServlet?currentPage=${pb.currentPage - 1}&rows=5" aria-label="Previous">
                    ...
                    <c:forEach begin="1" end="${pb.totalPage}" var="i" >
                        ...
                        <c:if test="${pb.currentPage == i}">
                            <li class="active"><a href="${pageContext.request.contextPath}/myTicketServlet?currentPage=${i}&rows=5">${i}</a></li>
                        </c:if>
                        <c:if test="${pb.currentPage != i}">
                            <li><a href="${pageContext.request.contextPath}/myTicketServlet?currentPage=${i}&rows=5">${i}</a></li>
                        </c:if>

                    </c:forEach>
                    <c:if test="${pb.currentPage != pb.totalPage}">
                        <li>
                            <a href="${pageContext.request.contextPath}/myTicketServlet?currentPage=${pb.currentPage + 1}&rows=5" aria-label="Next">
